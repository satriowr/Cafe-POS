        ...
        .then(tables => {
            ...
            if (tables.length === 0) {
                ...
                tables.forEach(table => {
                    ...
                    const orderIds = table.order_ids.join(',');
                    const href = `/admin/cashier/${table.table_number}?order_ids=${orderIds}`;
                    ...
                    col.innerHTML = `
                        <div class="card shadow-sm h-100">
                            <div class="card-body">
                                ...
                                <a href="${href}" class="btn w-100" style="background-color:#0E8636 !important; color:white;" target="_blank">Detail</a>
                            </div>
                        </div>
                    `;
